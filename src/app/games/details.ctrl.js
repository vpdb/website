...
const backglassModalTpl = require('./details.backglass.modal.pug')();
const mediumModalTpl = require('./details.medium.modal.pug')();
...
export default class GameDetailsCtrl {
	...
	showBackglass(backglass) {
		this.$uibModal.open({
			...
			controller: 'GameBackglassDetailsModalCtrl',
			controllerAs: 'vm',
			size: 'md',
			resolve: {
				params: () => {
	...
	showMedium(medium) {
		this.$uibModal.open({
			...
			controller: 'GameMediumDetailsModalCtrl',
			controllerAs: 'vm',
			size: 'md',
			resolve: {
				params: () => {
